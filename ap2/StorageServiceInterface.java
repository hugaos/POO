...
public interface StorageServiceInterface {
    boolean registerClient(int taxId, String name, String type);
    ...
    List<StorageUnit> findAvailableUnits(String unitType, LocalDate fromDate, int duration, int[] minDimensions);
